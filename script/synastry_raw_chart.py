...
async def main() -> None:
    payload = load_json_input("Calculate synastry raw chart JSON")
    add_ephemeris_path()
    ...
    chart = await KerykeionCalculator.calculate_synastry(
    ...
    print_json({"chart_type": "synastry", **chart.model_dump()})
